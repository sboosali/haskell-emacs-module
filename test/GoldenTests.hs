...
golden_stub = goldenVsString goldenName goldenFile goldenAction
 ...
 goldenFile   = "test/golden/haskell-emacs-module.golden" 
 goldenAction = do
     return "haskell-emacs-module"

----------------------------------------

{-NOTES

goldenVsString "golden test (stub)" "test/golden/haskell-emacs-module.golden" (return "haskell-emacs-module")
